...
const PATTERNS=[
 {type:'EXAMPLE_OF',re:/\b(?:הוא|היא)\s+דוגמ[אה]\s+ל\b/gu,base:.96},
 {type:'IS_A',re:/\b(?:הוא|היא)\s+(?:סוג|צורה|קטגוריה)\s+של\b/gu,base:.96},
 {type:'PART_OF',re:/\b(?:הוא|היא)?\s*חלק\s+מ\b/gu,base:.97},
 {type:'PART_OF',re:/\b(?:מורכב|מורכבת|מורכבים|מורכבות)\s+מ\b/gu,base:.9,reverse:true},
 {type:'PART_OF',re:/\b(?:כולל|כוללת|כוללים|כוללות)\b/gu,base:.87,reverse:true},
 {type:'DEPENDS_ON',re:/\b(?:תלוי|תלויה|תלויים|תלויות)\s+ב\b/gu,base:.95},
 {type:'INFLUENCES',re:/\b(?:משפיע|משפיעה|משפיעים|משפיעות)\s+על\b/gu,base:.97},
 {type:'REGULATES',re:/\b(?:מווסת|מווסתת|מווסתים|מווסתות)\s+(?:את\s+)?/gu,base:.97},
 {type:'CAUSES_OR_CONTRIBUTES_TO',re:/\b(?:גורם|גורמת|גורמים|גורמות)\s+ל/gu,base:.96},
 {type:'CAUSES_OR_CONTRIBUTES_TO',re:/\b(?:מוביל|מובילה|מובילים|מובילות)\s+ל/gu,base:.93},
 {type:'CAUSES_OR_CONTRIBUTES_TO',re:/\b(?:תורם|תורמת|תורמים|תורמות)\s+ל/gu,base:.89},
 {type:'CONTRADICTS',re:/\b(?:סותר|סותרת|סותרים|סותרות)\s+(?:את\s+)?/gu,base:.98},
 {type:'SUPPORTS',re:/\b(?:תומך|תומכת|תומכים|תומכות)\s+ב/gu,base:.9},
 {type:'EXPLAINS',re:/\b(?:מסביר|מסבירה|מסבירים|מסבירות)\s+(?:את\s+)?/gu,base:.93},
 {type:'APPLIES_TO',re:/\b(?:חל|חלה|חלים|חלות)\s+על\b/gu,base:.93},
 {type:'REFRAMES',re:/\b(?:ממסגר|ממסגרת|ממסגרים|ממסגרות)\s+מחדש\s+(?:את\s+)?/gu,base:.94},
 {type:'PREREQUISITE_FOR',re:/\b(?:תנאי\s+מוקדם|דרישת\s+קדם)\s+ל/gu,base:.98},
 {type:'REVISITED_BY',re:/\b(?:נחזור|חוזרים|נשוב)\s+(?:אל|ל)\b/gu,base:.72,pedagogic:true},
];
